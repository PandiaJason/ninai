                ...
                return (
                    <div className="home-loved-section">
                        <div className="home-loved-header">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="var(--accent-danger)" stroke="var(--accent-danger)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
